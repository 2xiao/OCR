 ...
 */
public class BankCardViewGenerator extends ContentGenerator {
    ...
    public BankCardViewGenerator(MainActivity activity) {
        super(activity);
    }

    @Override
    public View generate() {
        View view = View.inflate(getActivity(), R.layout.item_bankcard, null);
