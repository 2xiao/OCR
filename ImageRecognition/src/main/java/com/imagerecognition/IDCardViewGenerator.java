 ...
 */
public class IDCardViewGenerator extends ContentGenerator{
    ...
    public IDCardViewGenerator(MainActivity activity) {
        super(activity);
    }

    @Override
    public View generate() {
        View view = View.inflate(getActivity(), R.layout.item_idcard, null);
